...
def generate_qars(dataset, generator_models, judge_model, br_model):
    ...
    sample_syn_qars = load_json_file(file_name='sample_q_few_shot_cot_molmo_run_2.json') 
    
    # TODO: Create a separate judgement block and place it there
    kk = 0
    judged_syn_qars = []
